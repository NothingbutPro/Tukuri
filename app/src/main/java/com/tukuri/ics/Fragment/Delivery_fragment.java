...
import com.tukuri.ics.Adapter.Delivery_get_address_adapter;
...
import com.tukuri.ics.HttpHandler;
...
public class Delivery_fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((com.tukuri.ics.MainActivity) getActivity()).setTitle(getResources().getString(R.string.delivery));
